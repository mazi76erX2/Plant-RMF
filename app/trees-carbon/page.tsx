      ...
      <section className="w-full relative py-32 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
            Our tree planting initiatives aim to create greener, healthier
            communities while offsetting carbon emissions and fighting climate
            change.
          </p>
      ...
      <section className="w-full py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Discover our signature tree planting programs that are transforming
            communities and environments across South Africa.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Our flagship initiative includes Trees for All and Trees for
                  Homes programs, creating greener communities in shared spaces
                  and private homes.
                </p>
                <Link
                  href="/trees-carbon/community-tree-planting"
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Supporting pollinators and biodiversity, this program plants
                  bee-friendly trees to support ecosystem health and sustainable
                  agriculture.
                </p>
                <Link
                  href="/trees-carbon/trees-for-bees"
                  className="text-green-700 font-semibold hover:text-green-900 inline-flex items-center"
                >
                  Learn more
                  <svg
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Help your organization meet carbon reduction goals through our
                  verified carbon offset tree planting initiatives.
                </p>
                <Link
                  href="/trees-carbon/carbon-tax-offset"
                  className="text-green-700 font-semibold hover:text-green-900 inline-flex items-center"
                >
                  Learn more
                  <svg
          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Our carbon offset programs are designed to help businesses and
                individuals reduce their carbon footprint while contributing to
                the growth of green spaces and sustainable communities.
              </p>

              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                All of our tree planting initiatives are eligible for carbon
                offsetting, with proper monitoring and verification systems in
                place. Our Trees for Homes program is registered with the
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  <svg
                    className="w-6 h-6 text-green-600 mr-2 mt-1 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Support local communities and create green jobs
                  </span>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div className="order-1 md:order-2" variants={fadeInUp}>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Engage your employees in meaningful sustainability activities
                through our corporate volunteer days. Teams can participate in
                tree planting events, learn about environmental conservation,
                and make a tangible difference to communities.
              </p>
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Build team morale and employee engagement
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
      ...
      <section className="w-full py-16 bg-green-800 text-white">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Your contribution can help us plant more trees, create greener
            communities, and combat climate change. Every tree makes a
            difference.
          </p>
