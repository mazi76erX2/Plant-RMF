  ...
  return (
    <main className="flex flex-col items-center min-h-screen">
      ...
      <section className="w-full relative py-20 flex items-center justify-center">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Community Tree Planting</h1>
          <div className="flex items-center justify-center text-sm space-x-2">
            <Link href="/" className="hover:underline">Home</Link>
            <span>»</span>
            <Link href="/trees-carbon" className="hover:underline">Trees & Carbon</Link>
            <span>»</span>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-lg text-gray-700 leading-relaxed">
              <strong className="text-green-800 font-semibold">Community Tree Planting</strong> is made up of two of FTFA's flagship programmes – <strong className="text-green-800 font-semibold">Trees for All</strong> and <strong className="text-green-800 font-semibold">Trees for Homes</strong>. These programmes combine well to plant trees in both shared spaces (schools, hospitals, clinics, parks, etc.) and private homes, to create a healthier, more food secure environment.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
            >
              <h2 className="text-4xl font-bold mb-4 text-gray-800">Trees for All</h2>
              <h3 className="text-xl text-green-700 mb-6 italic">(Trees in Shared Spaces)</h3>
              
              <p className="text-gray-700 mb-6 leading-relaxed">
                <strong className="text-green-800 font-semibold">Trees for All</strong> is an award-winning programme that sustainably plants trees in shared spaces for a healthier, greener environment. This successful initiative educates communities about the benefits of trees, while offsetting carbon emissions and transforming the surrounding environment.
              </p>
              
              <p className="text-gray-700 mb-6 leading-relaxed">
                <strong className="text-green-800 font-semibold">Trees for All</strong> plants and monitors fruit and indigenous trees at:
              </p>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 mb-8">
                ...
                <li>anywhere else people will benefit from, and look after, trees.</li>
              </ul>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div 
              ...
              variants={fadeInUp}
            >
              <h2 className="text-4xl font-bold mb-6 text-gray-800">Trees for Homes</h2>
              
              <p className="text-gray-700 mb-6 leading-relaxed">
                <strong className="text-green-800 font-semibold">Trees for Homes</strong> is the most successful township, greening initiative in South Africa. Originally designed to address South Africa's history of inequitable settlement policies, the programme grew to become the country's benchmark of innovation in urban forestry.
              </p>
              
              <p className="text-gray-700 mb-6 leading-relaxed">
                A typical project sees two trees going to each home in a township:
              </p>
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Which trees a household receives depends on a number of factors but FTFA will ultimately choose trees that are going to have the best survival. In some projects the community members ask for two fruit / nut trees.
              </p>
              
              <p className="text-gray-700 mb-6 leading-relaxed">
                Developing community foresters with training and skills is also an integral part of the programmes design. These environmental champions create threads of awareness and appreciation and also have an opportunity for temporary and (potentially) long-term employment.
              </p>
              
              <p className="text-gray-700 mb-6 leading-relaxed">
                TFH is currently driving <strong className="text-green-800 font-semibold">greenbelt initiatives</strong> in a number of townships in major city centers nationally. We aim to transform these townships into rich urban food forests, teeming with life and biodiversity.
              </p>
              
              <p className="text-gray-700 mb-6 leading-relaxed">
                This programme is also registered with the VCS (Verified Carbon Standard) making it possible to utilise it as a carbon offset programme.
              </p>
            </motion.div>
            <motion.div 
      ...
      <section className="w-full py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold mb-6 text-green-800">Trees for All</h3>
            ...
            <motion.div 
              ...
              className="bg-gray-50 p-8 rounded-lg hover:shadow-md transition-all duration-300"
            >
              <h3 className="text-2xl font-bold mb-6 text-green-800">Trees for Homes</h3>
              <ul className="space-y-3">
      ...
      <section className="w-full py-16 bg-green-800">
        <motion.div 
          ...
          variants={fadeInUp}
        >
          <h2 className="text-4xl font-bold text-white mb-8">Plant a tree today.</h2>
          <motion.div
...
const TreeFruitIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M20.618 5.984A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016zM12 9v3m0 0v3m0-3h3m-3 0H9" />
  </svg>
);

const TreeBiodiversityIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 15c-1.932 0-3.5-1.568-3.5-3.5S10.068 8 12 8s3.5 1.568 3.5 3.5S13.932 15 12 15zm0 0c-3.866 0-7 1.79-7 4v1h14v-1c0-2.21-3.134-4-7-4z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 3v2M3 12h2M21 12h-2M12 19v2M19 5l-2 2M7 5l2 2M5 19l2-2M19 19l-2-2" />
  </svg>
);
