  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[60vh] min-h-[500px] w-full flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Community Planning</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-800">Community Assessment</h3>
            ...
            >
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-800">Participatory Design</h3>
                <p className="text-gray-600 mb-4">
            ...
            >
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-800">Sustainable Implementation</h3>
                <p className="text-gray-600 mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="w-full md:w-2/3">
                <h3 className="text-xl font-bold mb-3 text-gray-800">Urban Greening Project</h3>
                <p className="text-gray-600 mb-4">
