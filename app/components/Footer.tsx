        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-gray-300 text-center max-w-xl">
              The Robert Mazibuko Foundation is dedicated to environmental
              conservation, community development, and sustainable practices
              across South Africa.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <p className="flex items-start">
                  ...
                  <span>
                    <strong>Telephone:</strong> +27 82 597 0232
                  </span>
                </p>
                <p className="flex items-start">
                  <svg
                  ...
                  <span>
                    <strong>Email:</strong> admin@plant-rmf.org.za
                  </span>
                </p>
                <p className="flex items-start">
                  <svg
                  ...
                  <span>
                    <strong>Website:</strong> www.plant-rmf.org.za
                  </span>
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-6">
                <a
                  ...
                  className="bg-green-700/20 hover:bg-green-700/40 text-white p-3 rounded-full transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Stay updated with our latest news, projects, and events. We
      ...
      <div className="bg-gray-900 py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <p>
              © {new Date().getFullYear()} Robert Mazibuko Foundation. All
              rights reserved.
            </p>
            <div className="mt-3 md:mt-0">
              <Link
                href="/privacy-policy"
                className="hover:text-green-500 mr-4 transition-colors"
              >
                Privacy Policy
              </Link>
              <Link
