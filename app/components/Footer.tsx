        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://facebook.com/robertmazibukofoundation"
                target="_blank"
              ...
              <a
                href="https://twitter.com/RMFoundation"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-green-300"
              >
              ...
              <a
                href="https://instagram.com/robertmazibukofoundation"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-green-300"
              >
              ...
              <a
                href="https://linkedin.com/company/robert-mazibuko-foundation"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-green-300"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+27825970232" className="hover:text-green-300">
                  +27 82 597 0232
                </a>
              </li>
              <li className="flex items-center">
